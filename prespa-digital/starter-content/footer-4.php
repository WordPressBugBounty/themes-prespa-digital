...
<!-- /wp:group -->
    ',
    esc_html_x( 'Get in Touch', 'Theme starter content', 'prespa-digital' ),
    esc_url( 'mailto:info@example.com' ),
    esc_html_x( 'info@example.com', 'Theme starter content', 'prespa-digital' ),
    esc_html_x( 'Opening Hours: 10:00 – 13:00', 'Theme starter content', 'prespa-digital' )
);
